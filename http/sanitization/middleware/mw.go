...
import (
	...
	"github.com/rdevitto86/komodo-forge-sdk-go/http/sanitization"
)
...
func sanitizeString(str string) string {
	str = sanitization.NullBytePattern.ReplaceAllString(str, "")
	str = sanitization.PathTraversalPattern.ReplaceAllString(str, "")
	str = html.EscapeString(str)
	str = strings.TrimSpace(str)

	if sanitization.SqlInjectionPattern.MatchString(str) {
		str = sanitization.SqlInjectionPattern.ReplaceAllString(str, "")
	}
	str = sanitization.XssPattern.ReplaceAllString(str, "")
